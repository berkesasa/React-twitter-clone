        ...
        <div
            ...
            <label className="h-[43px] rounded-full w-full bg-[#202327] group focus-within:bg-black border border-transparent focus-within:border-[#1d9bf0] relative">
                ...
                <div className="w-[56px] h-full flex items-center justify-center absolute top-0 left-0 pointer-events-none">
                    <svg viewBox="0 0 24 24" height={18.75} className="min-w-[32px] group-focus-within:text-[#1d9bf0] text-[#71767b] ">
                ...
                <input
                    type="text"
                    className="w-full h-full bg-transparent placeholder-[#71767b] outline-none rounded-full pl-[60px] text-[15px]"
                    placeholder="Ara"
                    value={query}
            ...
            {focus && (
                <div
                    className="absolute top-full -translate-y-1 -left-px bg-black shadow-box max-h-[calc(80vh-53px)] w-[350px] rounded-lg text-center min-h-[100px]">
