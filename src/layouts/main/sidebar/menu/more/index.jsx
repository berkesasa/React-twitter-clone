...
function More() {
    return (
        <Popover className="relative">
            ...
            <Popover.Panel className="rounded-xl w-[318px] absolute bottom-0 left-0 bg-black shadow-box overflow-hidden">
                <button
                ...
                <Disclosure>
                    <Disclosure.Button className="h-[52px] flex items-center px-4 font-bold justify-between hover:bg-[#eff3f41a] w-full transition-colors">
